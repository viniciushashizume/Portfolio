  ...
  pt: {
    ...
    personalProjects: [
      ...
      },
      {
        ...
        description: "API RESTful com Python e Flask que serve como backend para um bot de tradução no WhatsApp. O sistema é arquitetado em torno de um webhook que recebe eventos de mensagens da Plataforma Cloud da Meta em tempo real.",
